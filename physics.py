...
# На основании этих данных происходит отрисовка ступени на новом положении.
...
GravitationalAcceleration = VectorComplex.get_instance(0., - GRAVITY_ACCELERATION_ABS)
