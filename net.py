...
# Актор:
# - Входы:
# -- Линейные параметры в СКИП (положение, скорость, ускорение), 2+2+2
# до 300 км, 8000 м/с, ускорение определить по силе двигателя/силе тяжести
# -- Угловые параметры (ориентация, угловая скорость, угловое ускорение), 1+1+1
# -- Длительность до съёма следующих показаний, время в миллисекундах 0-1000, 1
# -- Вход-индикатор работы микросекундного входа, вкл / выкл, 1
# -- Длительность до съёма следующих показаний, время в секундах, 0-1000, 1
# -- Вход-индикатор работы секундного входа, вкл / выкл, 1
# - Выходы:
# -- включение конкретного двигателя (5 шт.)
